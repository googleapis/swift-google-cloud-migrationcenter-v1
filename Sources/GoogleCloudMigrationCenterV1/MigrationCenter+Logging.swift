...
extension Clients {
  final class MigrationCenterLogging: MigrationCenterStub {
    let inner: any MigrationCenterStub
    let logger: Logger

    public init(_ inner: any MigrationCenterStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = "google-cloud-migrationcenter-v1"
      logger[metadataKey: "gcp.client.service"] = "migrationcenter"
      logger[metadataKey: "gcp.experimental.swift.client"] = "MigrationCenter"
      self.inner = inner
      self.logger = logger
    }
