# Google Cloud Client Libraries for Swift - Migration Center API
...
Add `swift-google-cloud-migrationcenter-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-migrationcenter-v1.git --from 0.0.0-preview
```

Then add `GoogleCloudMigrationCenterV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudMigrationCenterV1 <target-name> --package swift-google-cloud-migrationcenter-v1
```
